    ...
    return (
        <section className="flex justify-center items-center">
            ...
            <button title="Two per row"
                    className={`border w-20 h-20 flex items-center justify-center ${active === 2 ? 'bg-black text-white' : ''}`}
                    onClick={() => setActive(2)}
            >
                <BsGrid3X2 size="24"/>
            </button>
            ...
            <button title="Four per row"
                    className={`border w-20 h-20 flex items-center justify-center ${active === 4 ? 'bg-black text-white' : ''}`}
                    onClick={() => setActive(4)}
            >
                <BsGrid3X3 size="24"/>
            </button>
